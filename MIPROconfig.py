...
import yaml
from config import (
    MODEL_NAME, OLLAMA_BASE_URL, TEMPERATURE, MAX_TOKENS,
    DATA_DIR, N_TRIALS, BATCH_SIZE, N_INSTRUCTION_CANDIDATES,
    EVAL_BATCH_SIZE, N_STARTUP_TRIALS, METRIC, OUTPUT_DIR, CHECKPOINT_DIR
)
